# This script splits the dataset from data_prep_3 into a development dataset and an operations dataset
#   The dev dataset is to be used for development of the model that would go into production (demo)
#   Once in production, the ops dataset would be used to make predictions, update the model and evaluate
#   Input: bs_ct_merged_consolidated_3m.csv
#   Outputs: base_data_dev_3m.csv, base_data_ops_3m.csv
